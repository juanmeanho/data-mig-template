<template>
    <v-layout row>
          ...
          <v-flex>
            <div>
              <v-app-bar 
                ...
                width="100%"
                >
                <v-card class="rounded-card pl-12 pt-10" flat  color="rgba(255,255,255,0.1)" height="154" width="225">
                  <v-img height="auto" max-width="85" class="mt-4 ml-6" src="@/assets/logo-dmw-1.png" >
                  </v-img>
                </v-card> 
                  ...
                  <div class="hidden-sm-and-down flex-grow-1"></div>
                    <v-btn class="hidden-sm-and-down custom-transform-class text-none grey--text text--lighten-2" text>El Proyecto</v-btn>
                  <div class="hidden-sm-and-down flex-grow-1"></div>
                    <v-btn class="hidden-sm-and-down custom-transform-class text-none grey--text text--lighten-2" text>Datasets</v-btn>
                  <div class="hidden-sm-and-down flex-grow-1"></div>
                    <v-btn class="hidden-sm-and-down custom-transform-class text-none grey--text text--lighten-2" text>Referencias Externas</v-btn>
                  <div class="hidden-sm-and-down flex-grow-1 "></div>
                    <v-btn class="hidden-sm-and-down grey--text text--lighten-2" text>ES-EN</v-btn>
            ...
            <div v-show="!switchToolbar">
              <v-app-bar 
                ...
                width="100%"
                >
                <v-card flat  class="rounded-card pl-12 pt-10"  color="rgba(150,150,150,0.1)" height="104" width="225">
                  <v-img height="auto" max-width="104" class="mt-0" src="@/assets/group-22.png" >
                  </v-img>
                </v-card> 
                  <v-btn class="hidden-sm-and-down text-none ml-4 mt-2" text>
                    <span class="primer-item-toolbar">
                      Iniciativa de Migraciones
                    </span>
                  </v-btn>
                  <div class="hidden-sm-and-down flex-grow-1"></div>
                    <v-btn class="hidden-sm-and-down custom-transform-class text-none mt-2" text>
                      <span class="items-toolbar">
                        El Proyecto
                      </span>
                    </v-btn>
                  <div class="hidden-sm-and-down flex-grow-1"></div>
              ...
              <v-card flat color="white" height="201" class="pl-12 mb-n12">
                <v-card color="transparent" height="201" flat class="mt-0 ml-12 hidden-sm-and-down" max-width="945">   
                  <v-row>
                    <v-card width="154" flat></v-card>
                    <v-layout  row v-for="card in cards" :key="card.title" :cols="card.flex" mt-0>
                        <v-flex >
                          <div >
                            <v-card style="z-index: 9999" :to="{ name: 'Dashboard', params: { nu_id: card.text, text_id: card.title } }" 
                                target="_blank" color="white" flat width="201px" height="201" 
                                class="rounded-card mt-0 py-0 pt-0">
                              <div  class="hover-tb pt-4 pl-2" style="height:100%;">
                                <div class="hover-tb" >
                                  <v-card-text class=numbers-tb
                                      v-text="card.text"
                                  ></v-card-text>
                                  <v-card-text class="flujos-tb"
                                      v-text="card.title"
                                  ></v-card-text>
                                </div>
                              </div>
        ...
        <template xs12>
          <v-container v-show="!switchToolbar"  class="pa-2" fluid :class="{'mt-n12': $vuetify.breakpoint.mdAndUp}">
              <title-hero-mobile class="mt-n8"></title-hero-mobile>
          </v-container>
        </template>
        <template  xs12>
          <v-container v-show="switchToolbar" class="pa-2" fluid :class="{'mt-4': $vuetify.breakpoint.mdAndUp}">
